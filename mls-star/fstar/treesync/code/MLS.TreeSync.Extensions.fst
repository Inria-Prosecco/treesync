...
val get_extension: #bytes:Type0 -> {|bytes_like bytes|} -> extension_type_nt -> list (extension_nt bytes) -> option bytes
...
val set_extension: #bytes:Type0 -> {|bytes_like bytes|} -> extension_type_nt -> list (extension_nt bytes) -> bytes -> result (mls_list bytes ps_extension_nt )
...
val mk_get_extension: #bytes:Type0 -> {|bytes_like bytes|} -> #a:Type0 -> extension_type_nt -> parser_serializer bytes a -> list (extension_nt bytes) -> option a
