...
val valid_leaves_invariant_tree_remove: #bytes:Type0 -> {|crypto_bytes bytes|} -> #tkt:treekem_types bytes -> #l:nat -> #i:tree_index l -> group_id:mls_bytes bytes -> t:treesync bytes tkt l i -> li:leaf_index l i -> Lemma
...
val valid_leaves_invariant_apply_path_aux: #bytes:Type0 -> {|crypto_bytes bytes|} -> #tkt:treekem_types bytes -> #l:nat -> #i:tree_index l -> #li:leaf_index l i -> group_id:mls_bytes bytes -> t:treesync bytes tkt l i -> p:pathsync bytes tkt l i li -> parent_parent_hash:mls_bytes bytes -> Lemma
  (requires leaf_is_valid (get_path_leaf p) group_id li /\ valid_leaves_invariant group_id t /\ apply_path_aux_pre t p (length #bytes parent_parent_hash))
...
val valid_leaves_invariant_apply_path: #bytes:Type0 -> {|crypto_bytes bytes|} -> #tkt:treekem_types bytes -> #l:nat -> #li:leaf_index l 0 -> group_id:mls_bytes bytes -> t:treesync bytes tkt l 0 -> p:pathsync bytes tkt l 0 li -> Lemma
  (requires leaf_is_valid (get_path_leaf p) group_id li /\ valid_leaves_invariant group_id t /\ apply_path_pre t p)
...
val valid_leaves_invariant_mk_blank_tree: #bytes:Type0 -> {|crypto_bytes bytes|} -> #tkt:treekem_types bytes -> group_id:mls_bytes bytes -> l:nat -> i:tree_index l -> Lemma
...
val valid_leaves_invariant_tree_extend: #bytes:Type0 -> {|crypto_bytes bytes|} -> #tkt:treekem_types bytes -> #l:nat -> group_id:mls_bytes bytes -> t:treesync bytes tkt l 0 -> Lemma
  (requires valid_leaves_invariant group_id t)
...
val valid_leaves_invariant_tree_truncate: #bytes:Type0 -> {|crypto_bytes bytes|} -> #tkt:treekem_types bytes -> #l:pos -> group_id:mls_bytes bytes -> t:treesync bytes tkt l 0{is_tree_empty (TNode?.right t)} -> Lemma
  (requires valid_leaves_invariant group_id t)
