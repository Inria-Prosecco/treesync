...
val leaf_at_tree_change_path: #leaf_t:Type -> #node_t:Type -> #l:nat -> #i:tree_index l -> t:tree leaf_t node_t l i -> li:leaf_index l i -> leaf_content:leaf_t -> node_content:node_t -> li':leaf_index l i -> Lemma
...
val leaf_at_tree_update: #leaf_t:Type -> #node_t:Type -> #l:nat -> #i:tree_index l -> t:tree (option leaf_t) (option node_t) l i -> li:leaf_index l i -> leaf_content:leaf_t -> li':leaf_index l i -> Lemma
...
val leaf_at_tree_remove: #leaf_t:Type -> #node_t:Type -> #l:nat -> #i:tree_index l -> t:tree (option leaf_t) (option node_t) l i -> li:leaf_index l i -> li':leaf_index l i -> Lemma
...
val leaf_at_mk_blank_tree_general: #leaf_t:Type -> #node_t:Type -> l:nat -> i:tree_index l -> leaf_content:leaf_t -> node_content:node_t -> li':leaf_index l i -> Lemma
...
val leaf_at_tree_extend: #leaf_t:Type -> #node_t:Type -> #l:nat -> t:tree (option leaf_t) (option node_t) l 0 -> li':leaf_index (l+1) 0 -> Lemma
