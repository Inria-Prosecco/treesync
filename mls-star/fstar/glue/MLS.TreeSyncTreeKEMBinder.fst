...
val treesync_to_treekem_node_package: #bytes:Type0 -> {|crypto_bytes bytes|} -> parent_node_nt bytes tkt -> result (key_package bytes)
...
val treesync_to_treekem: #bytes:Type0 -> {|crypto_bytes bytes|} -> #l:nat -> #i:tree_index l -> treesync bytes tkt l i -> result (treekem bytes l i)
...
val treekem_to_treesync: #bytes:Type0 -> {|crypto_bytes bytes|} -> #l:nat -> #i:tree_index l -> #li:leaf_index l i -> leaf_node_data_nt bytes tkt -> pathkem bytes l i li -> result (external_pathsync bytes tkt l i li)
