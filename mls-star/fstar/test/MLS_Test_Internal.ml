...
let dummy_user_a = List.map Char.code [ 'a'; 'l'; 'i'; 'c'; 'e' ]
let dummy_user_b = List.map Char.code [ 'b'; 'o'; 'b' ]
let dummy_user_c = List.map Char.code [ 'c'; 'a'; 'r'; 'o'; 'l' ]
