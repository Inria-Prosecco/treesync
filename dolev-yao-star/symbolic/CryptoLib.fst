...
assume val pk_len: bytes -> pos
assume val rand_len: label -> usage -> pos
assume val pke_enc_len: bytes -> bytes -> bytes -> pos
assume val extract_len: bytes -> bytes -> pos
assume val expand_len: bytes -> bytes -> pos
assume val aead_len: bytes -> bytes -> bytes -> bytes -> pos
assume val vk_len: bytes -> pos
assume val sign_len: bytes -> bytes -> bytes -> pos
assume val mac_len: bytes -> bytes -> pos
assume val hash_len: bytes -> pos
assume val dh_pk_len: bytes -> pos
assume val dh_len: bytes -> bytes -> pos
